...
var (
	...
	// 0x2d573e7996698c330d687fa3a2595153c33c05bd584acf07f98689f90e429a3d
...
var (
	...
	// MainnetTrustedCheckpoint contains the light client trusted checkpoint for the Rinkeby test network.
	...
	MainnetCheckpointOracle = &CheckpointOracleConfig{
		Address: common.HexToAddress("0xcebcbf16494edbad87d7feab0260ade82c571e5d"),
		Signers: []common.Address{
			//common.HexToAddress("0xf39fd6e51aad88f6f4ce6ab8827279cfffb92266"), // Peter
			common.HexToAddress("0xcebcbf16494edbad87d7feab0260ade82c571e5d"), // Martin
	...
	RinkebyCheckpointOracle = &CheckpointOracleConfig{
		Address: common.HexToAddress("0x18D7e46EC485089BCC8003C9d88E5A201Ba860A5"),
		Signers: []common.Address{
			common.HexToAddress("0x18D7e46EC485089BCC8003C9d88E5A201Ba860A5"), // Peter
			common.HexToAddress("0x78d1aD571A1A09D60D9BBf25894b44e4C8859595"), // Martin
			common.HexToAddress("0x286834935f4A8Cfb4FF4C77D5770C2775aE2b0E7"), // Zsolt
			common.HexToAddress("0xb86e2B0Ab5A4B1373e40c51A7C712c70Ba2f9f8E"), // Gary
		},
	...
	AllEthashProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, new(EthashConfig), nil, &BorConfig{BurntContract: map[string]string{"0": "0x000000000000000000000000000000000000dead"}}}
	...
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
	AllCliqueProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, &CliqueConfig{Period: 0, Epoch: 30000}, &BorConfig{BurntContract: map[string]string{"0": "0x000000000000000000000000000000000000dead"}}}

	TestChainConfig = &ChainConfig{big.NewInt(1), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, new(EthashConfig), nil, &BorConfig{Sprint: map[string]uint64{
		"0": 4,
...
type ChainConfig struct {
	...
	//AuthBlock           *big.Int `json:"authBlock,omitempty"`           // London switch block (nil = no fork, 0 = already on london)
...
func (c *ChainConfig) IsImplAuth(num *big.Int) bool {
	return isForked(big.NewInt(10), num)
}
