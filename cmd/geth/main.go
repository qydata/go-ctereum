...
import (
	...
	_ "github.com/ethereum/go-ctereum/eth/tracers/js"
	_ "github.com/ethereum/go-ctereum/eth/tracers/native"
)
...
var (
	...
	app = flags.NewApp(gitCommit, gitDate, "the go-ctereum command line interface")
...
func init() {
	...
	app.Copyright = "Copyright 2013-2022 The go-ctereum Authors"
