...
//
// Detailed usage document and tutorial available on the go-ctereum Wiki page:
// https://github.com/ethereum/go-ctereum/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
